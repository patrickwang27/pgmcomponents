...
static PyObject *impl_scipy$optimize$_linprog$$$function__3_linprog(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_13 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_7 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_8 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_9 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
