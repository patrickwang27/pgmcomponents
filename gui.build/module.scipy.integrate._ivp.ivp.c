...
static PyObject *impl_scipy$integrate$_ivp$ivp$$$function__5_solve_ivp(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_6 = impl___main__$$$function__1__unpack_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_6 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    branch_no_10:;
    {
...

        {
            ...
            tmp_assign_source_17 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
