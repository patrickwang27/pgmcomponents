...
static PyObject *impl_PIL$TiffTags$$$function__4__populate(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_1:;
    {
...

        {
            ...
            tmp_ass_subvalue_3 = impl___main__$$$function__15_complex_call_helper_pos_star_list(tstate, dir_call_args);
        }
...

    {
...

        {
            ...
            tmp_ass_subvalue_4 = impl___main__$$$function__15_complex_call_helper_pos_star_list(tstate, dir_call_args);
        }
