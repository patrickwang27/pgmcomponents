...
static PyObject *impl_scipy$optimize$_root$$$function__1_root(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_10:;
    {
...

        {
            ...
            tmp_assign_source_8 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_11 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
...
static PyObject *impl_scipy$optimize$_root$$$function__4__root_nonlin_solve$$$function__1_f(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
...

        {
            ...
            tmp_expression_value_1 = impl___main__$$$function__15_complex_call_helper_pos_star_list(tstate, dir_call_args);
        }
