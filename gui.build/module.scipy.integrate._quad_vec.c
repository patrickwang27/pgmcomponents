...
static PyObject *impl_scipy$integrate$_quad_vec$$$function__14_quad_vec(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_4:;
    {
...

        {
            ...
            tmp_return_value = impl___main__$$$function__7_complex_call_helper_pos_star_dict(tstate, dir_call_args);
        }
        if (tmp_return_value == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    branch_yes_9:;
    {
...

        {
            ...
            tmp_assign_source_14 = impl___main__$$$function__7_complex_call_helper_pos_star_dict(tstate, dir_call_args);
        }
    ...
    branch_no_9:;
    {
...

        {
            ...
            tmp_assign_source_15 = impl___main__$$$function__7_complex_call_helper_pos_star_dict(tstate, dir_call_args);
        }
