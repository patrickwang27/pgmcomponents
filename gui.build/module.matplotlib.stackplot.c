...
static PyObject *impl_matplotlib$stackplot$$$function__1_stackplot(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_end_2:;
    {
...

        {
            ...
            tmp_assign_source_25 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_14 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
