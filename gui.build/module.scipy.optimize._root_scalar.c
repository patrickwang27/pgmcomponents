...
static PyObject *impl_scipy$optimize$_root_scalar$$$function__2___call__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
...

        {
            ...
            tmp_assign_source_1 = impl___main__$$$function__15_complex_call_helper_pos_star_list(tstate, dir_call_args);
        }
...
static PyObject *impl_scipy$optimize$_root_scalar$$$function__3_fprime(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1};
            tmp_call_result_1 = impl___main__$$$function__15_complex_call_helper_pos_star_list(tstate, dir_call_args);
        }
...
static PyObject *impl_scipy$optimize$_root_scalar$$$function__6_root_scalar(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_3 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_4 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_5 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_6 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
