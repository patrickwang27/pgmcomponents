...
static PyObject *impl_scipy$optimize$_lsq$trf$$$function__3_trf_bounds(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_expression_value_22 = impl___main__$$$function__7_complex_call_helper_pos_star_dict(tstate, dir_call_args);
        }
...
static PyObject *impl_scipy$optimize$_lsq$trf$$$function__4_trf_no_bounds(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_expression_value_14 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
